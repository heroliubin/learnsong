...
public class ImplRecyclerViewRefreshStateCall implements RefreshRecyclerView.RecyclerViewRefreshStateCall {
    ...
    public ImplRecyclerViewRefreshStateCall(RefreshRecyclerView pullRefreshRecyclerView) {
