...
//       在这里以flag作为一个标识，第一遍走initAttrs时，将flag设为true，也就是第二次才走initView
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            refreshHeadviewId = typedArray.getResourceId(R.styleable.RefreshRecyclerView_refresh_header_view, 0);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (getScrollY() > 0) {
                    //防止在正在刷新状态下，上拉出空白
                } else if (getScrollY() <= 0 && getScrollY() > -refreshHeadviewHeight * 2) {
                    //最多下拉到头布局高度5倍的距离
                    scrollBy(0, -deltaY / 2);
                }
